...
trait Text {
    ...
    fn get_bounded_ranges(
        ...
        xClipType: u32,
        yClipType: u32,
    ) -> zbus::Result<Vec<(i32, i32, String, zvariant::OwnedValue)>>;
    ...
    fn get_text_after_offset(&self, offset: i32, r#type: u32) -> zbus::Result<(String, i32, i32)>;

    /// GetTextAtOffset method
    fn get_text_at_offset(&self, offset: i32, r#type: u32) -> zbus::Result<(String, i32, i32)>;

    /// GetTextBeforeOffset method
    fn get_text_before_offset(&self, offset: i32, r#type: u32) -> zbus::Result<(String, i32, i32)>;
