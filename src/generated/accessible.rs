...
trait Accessible {
    ...
    fn get_application(&self) -> zbus::Result<(String, zvariant::OwnedObjectPath)>;

    /// GetAttributes method
    fn get_attributes(&self) -> zbus::Result<std::collections::HashMap<String, String>>;

    /// GetChildAtIndex method
    fn get_child_at_index(&self, index: i32) -> zbus::Result<(String, zvariant::OwnedObjectPath)>;

    /// GetChildren method
    fn get_children(&self) -> zbus::Result<Vec<(String, zvariant::OwnedObjectPath)>>;
    ...
    fn get_relation_set(
        &self,
    ) -> zbus::Result<Vec<(u32, Vec<(String, zvariant::OwnedObjectPath)>)>>;
