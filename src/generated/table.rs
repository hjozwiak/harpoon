...
trait Table {
    ...
    fn get_column_header(&self, column: i32) -> zbus::Result<(String, zvariant::OwnedObjectPath)>;
    ...
    /// GetRowHeader method
    fn get_row_header(&self, row: i32) -> zbus::Result<(String, zvariant::OwnedObjectPath)>;
    ...
    /// Caption property
    #[dbus_proxy(property)]
    fn caption(&self) -> zbus::Result<(String, zvariant::OwnedObjectPath)>;
    ...
    /// Summary property
    #[dbus_proxy(property)]
    fn summary(&self) -> zbus::Result<(String, zvariant::OwnedObjectPath)>;
}
