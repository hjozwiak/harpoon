...
pub trait OrgA11yAtspiAccessible {
    ...
    fn get_relation_set(
        &self,
    ) -> Result<Vec<(u32, Vec<(String, dbus::Path<'static>)>)>, tree::MethodErr>;
    ...
    fn get_attributes(
        &self,
    ) -> Result<::std::collections::HashMap<String, String>, tree::MethodErr>;
...
pub fn org_a11y_atspi_accessible_server<F, T, D>(
...
pub fn org_a11y_atspi_action_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_application_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub trait OrgA11yAtspiCollection {
    fn get_matches(
        ...
        count: i32,
        traverse: bool,
    ) -> Result<Vec<(String, dbus::Path<'static>)>, tree::MethodErr>;
    fn get_matches_to(
        &self,
        current_object: dbus::Path,
        rule: (
            Vec<i32>,
            i32,
            ::std::collections::HashMap<&str, &str>,
...
pub fn org_a11y_atspi_collection_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_component_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_document_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_hypertext_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_hyperlink_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_image_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_selection_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub trait OrgA11yAtspiTable {
    ...
    fn get_row_column_extents_at_index(
        &self,
        index: i32,
    ) -> Result<(bool, i32, i32, i32, i32, bool), tree::MethodErr>;
...
pub fn org_a11y_atspi_table_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
    ...
    F: 'static + for<'z> Fn(&'z tree::MethodInfo<tree::MTFn<D>, D>) -> &'z T,
{
    ...
    let h = move |minfo: &tree::MethodInfo<tree::MTFn<D>, D>| {
        ...
        let index: i32 = i.read()?;
        let d = fclone(minfo);
        let (arg0, row, col, row_extents, col_extents, is_selected) =
            d.get_row_column_extents_at_index(index)?;
        let rm = minfo.msg.method_return();
        let rm = rm.append1(arg0);
...
pub fn org_a11y_atspi_table_cell_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub trait OrgA11yAtspiText {
    fn get_string_at_offset(
        ...
        offset: i32,
        granularity: u32,
    ) -> Result<(String, i32, i32), tree::MethodErr>;
    ...
    fn get_attributes(
        &self,
        offset: i32,
    ) -> Result<(::std::collections::HashMap<String, String>, i32, i32), tree::MethodErr>;
    ...
    fn get_character_extents(
        ...
        offset: i32,
        coord_type: u32,
    ) -> Result<(i32, i32, i32, i32), tree::MethodErr>;
    fn get_offset_at_point(
        &self,
        x_: i32,
        y_: i32,
        coord_type: u32,
    ) -> Result<i32, tree::MethodErr>;
...
pub fn org_a11y_atspi_text_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
    ...
    F: 'static + for<'z> Fn(&'z tree::MethodInfo<tree::MTFn<D>, D>) -> &'z T,
{
    ...
    let h = move |minfo: &tree::MethodInfo<tree::MTFn<D>, D>| {
        ...
        let d = fclone(minfo);
        let arg0 =
            d.get_bounded_ranges(x_, y_, width, height, coord_type, x_clip_type, y_clip_type)?;
        let rm = minfo.msg.method_return();
        let rm = rm.append1(arg0);
        Ok(vec![rm])
    };
...
pub fn org_a11y_atspi_editable_text_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_cache_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_value_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_registry_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_device_event_controller_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_atspi_device_event_listener_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_status_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
...
pub fn org_a11y_bus_server<F, T, D>(
    factory: &tree::Factory<tree::MTFn<D>, D>,
    data: D::Interface,
    f: F,
) -> tree::Interface<tree::MTFn<D>, D>
