...
// Callbacks
pub type AtspiDeviceListenerCB = Option<unsafe extern "C" fn(*mut AtspiDeviceEvent, *mut c_void) -> gboolean>;
...
pub type AtspiKeyCallback = Option<unsafe extern "C" fn(*mut AtspiDevice, gboolean, c_uint, c_uint, c_uint, *const c_char, *mut c_void)>;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct AtspiDeviceClass {
    pub parent_class: gobject::GObjectClass,
    pub add_key_grab: Option<unsafe extern "C" fn(*mut AtspiDevice, *mut AtspiKeyDefinition)>,
    pub remove_key_grab: Option<unsafe extern "C" fn(*mut AtspiDevice, c_uint)>,
    pub map_modifier: Option<unsafe extern "C" fn(*mut AtspiDevice, c_int) -> c_uint>,
    pub unmap_modifier: Option<unsafe extern "C" fn(*mut AtspiDevice, c_int)>,
    pub get_modifier: Option<unsafe extern "C" fn(*mut AtspiDevice, c_int) -> c_uint>,
    pub grab_keyboard: Option<unsafe extern "C" fn(*mut AtspiDevice) -> gboolean>,
    pub ungrab_keyboard: Option<unsafe extern "C" fn(*mut AtspiDevice)>,
    pub get_locked_modifiers: Option<unsafe extern "C" fn(*mut AtspiDevice) -> c_uint>,
}

impl ::std::fmt::Debug for AtspiDeviceClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AtspiDeviceClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .field("add_key_grab", &self.add_key_grab)
         .field("remove_key_grab", &self.remove_key_grab)
         .field("map_modifier", &self.map_modifier)
         .field("unmap_modifier", &self.unmap_modifier)
         .field("get_modifier", &self.get_modifier)
         .field("grab_keyboard", &self.grab_keyboard)
         .field("ungrab_keyboard", &self.ungrab_keyboard)
         .field("get_locked_modifiers", &self.get_locked_modifiers)
         .finish()
    }
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct AtspiDeviceLegacyClass {
    pub parent_class: AtspiDeviceClass,
}

impl ::std::fmt::Debug for AtspiDeviceLegacyClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AtspiDeviceLegacyClass @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct AtspiDeviceX11Class {
    pub parent_class: AtspiDeviceClass,
}

impl ::std::fmt::Debug for AtspiDeviceX11Class {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AtspiDeviceX11Class @ {:p}", self))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct AtspiDevice {
    pub parent: gobject::GObject,
}

impl ::std::fmt::Debug for AtspiDevice {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AtspiDevice @ {:p}", self))
         .field("parent", &self.parent)
         .finish()
    }
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct AtspiDeviceLegacy {
    pub parent: AtspiDevice,
}

impl ::std::fmt::Debug for AtspiDeviceLegacy {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AtspiDeviceLegacy @ {:p}", self))
         .field("parent", &self.parent)
         .finish()
    }
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct AtspiDeviceX11 {
    pub parent: AtspiDevice,
}

impl ::std::fmt::Debug for AtspiDeviceX11 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AtspiDeviceX11 @ {:p}", self))
         .field("parent", &self.parent)
         .finish()
    }
}
...
extern "C" {
    ...
    // AtspiDevice
    //=========================================================================
    pub fn atspi_device_get_type() -> GType;
    pub fn atspi_device_new() -> *mut AtspiDevice;
    pub fn atspi_device_add_key_grab(device: *mut AtspiDevice, kd: *mut AtspiKeyDefinition, callback: AtspiKeyCallback, user_data: *mut c_void, callback_destroyed: glib::GDestroyNotify) -> c_uint;
    pub fn atspi_device_add_key_watcher(device: *mut AtspiDevice, callback: AtspiKeyCallback, user_data: *mut c_void, callback_destroyed: glib::GDestroyNotify);
    pub fn atspi_device_get_grab_by_id(device: *mut AtspiDevice, id: c_uint) -> *mut AtspiKeyDefinition;
    pub fn atspi_device_get_locked_modifiers(device: *mut AtspiDevice) -> c_uint;
    pub fn atspi_device_get_modifier(device: *mut AtspiDevice, keycode: c_int) -> c_uint;
    pub fn atspi_device_grab_keyboard(device: *mut AtspiDevice) -> gboolean;
    pub fn atspi_device_map_modifier(device: *mut AtspiDevice, keycode: c_int) -> c_uint;
    pub fn atspi_device_notify_key(device: *mut AtspiDevice, pressed: gboolean, keycode: c_int, keysym: c_int, state: c_int, text: *mut c_char) -> gboolean;
    pub fn atspi_device_remove_key_grab(device: *mut AtspiDevice, id: c_uint);
    pub fn atspi_device_ungrab_keyboard(device: *mut AtspiDevice);
    pub fn atspi_device_unmap_modifier(device: *mut AtspiDevice, keycode: c_int);

    //=========================================================================
    // AtspiDeviceLegacy
    //=========================================================================
    pub fn atspi_device_legacy_get_type() -> GType;
    pub fn atspi_device_legacy_new() -> *mut AtspiDeviceLegacy;
    ...
    // AtspiDeviceX11
    //=========================================================================
    pub fn atspi_device_x11_get_type() -> GType;
    pub fn atspi_device_x11_new() -> *mut AtspiDeviceX11;
