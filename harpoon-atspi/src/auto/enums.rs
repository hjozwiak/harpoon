...
#[derive(Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "AtspiKeyEventType")]
pub enum KeyEventType {
    #[doc(alias = "ATSPI_KEY_PRESSED")]
    Pressed,
    #[doc(alias = "ATSPI_KEY_RELEASED")]
    Released,
#[doc(hidden)]
    __Unknown(i32),
}

impl fmt::Display for KeyEventType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "KeyEventType::{}", match *self {
...
#[doc(hidden)]
impl IntoGlib for KeyEventType {
    type GlibType = ffi::AtspiKeyEventType;

    fn into_glib(self) -> ffi::AtspiKeyEventType {
        match self {
            Self::Pressed => ffi::ATSPI_KEY_PRESSED,
            Self::Released => ffi::ATSPI_KEY_RELEASED,
            Self::__Unknown(value) => value,
}
    }
}
...
#[doc(hidden)]
impl FromGlib<ffi::AtspiKeyEventType> for KeyEventType {
    unsafe fn from_glib(value: ffi::AtspiKeyEventType) -> Self {
        skip_assert_initialized!();
        match value {
            ffi::ATSPI_KEY_PRESSED => Self::Pressed,
            ffi::ATSPI_KEY_RELEASED => Self::Released,
            value => Self::__Unknown(value),
}
    }
}

impl StaticType for KeyEventType {
    fn static_type() -> Type {
        unsafe { from_glib(ffi::atspi_key_event_type_get_type()) }
    }
}

impl glib::value::ValueType for KeyEventType {
    type Type = Self;
}

unsafe impl<'a> FromValue<'a> for KeyEventType {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
#[derive(Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "AtspiLocaleType")]
pub enum LocaleType {
    #[doc(alias = "ATSPI_LOCALE_TYPE_MESSAGES")]
    Messages,
    #[doc(alias = "ATSPI_LOCALE_TYPE_COLLATE")]
    Collate,
    #[doc(alias = "ATSPI_LOCALE_TYPE_CTYPE")]
    Ctype,
    #[doc(alias = "ATSPI_LOCALE_TYPE_MONETARY")]
    Monetary,
    #[doc(alias = "ATSPI_LOCALE_TYPE_NUMERIC")]
    Numeric,
    #[doc(alias = "ATSPI_LOCALE_TYPE_TIME")]
    Time,
#[doc(hidden)]
    __Unknown(i32),
}
...
#[doc(hidden)]
impl IntoGlib for LocaleType {
    type GlibType = ffi::AtspiLocaleType;

    fn into_glib(self) -> ffi::AtspiLocaleType {
        match self {
            Self::Messages => ffi::ATSPI_LOCALE_TYPE_MESSAGES,
            Self::Collate => ffi::ATSPI_LOCALE_TYPE_COLLATE,
            Self::Ctype => ffi::ATSPI_LOCALE_TYPE_CTYPE,
            Self::Monetary => ffi::ATSPI_LOCALE_TYPE_MONETARY,
            Self::Numeric => ffi::ATSPI_LOCALE_TYPE_NUMERIC,
            Self::Time => ffi::ATSPI_LOCALE_TYPE_TIME,
            Self::__Unknown(value) => value,
}
    }
}
...
#[doc(hidden)]
impl FromGlib<ffi::AtspiLocaleType> for LocaleType {
    unsafe fn from_glib(value: ffi::AtspiLocaleType) -> Self {
        skip_assert_initialized!();
        match value {
            ffi::ATSPI_LOCALE_TYPE_MESSAGES => Self::Messages,
            ffi::ATSPI_LOCALE_TYPE_COLLATE => Self::Collate,
            ffi::ATSPI_LOCALE_TYPE_CTYPE => Self::Ctype,
            ffi::ATSPI_LOCALE_TYPE_MONETARY => Self::Monetary,
            ffi::ATSPI_LOCALE_TYPE_NUMERIC => Self::Numeric,
            ffi::ATSPI_LOCALE_TYPE_TIME => Self::Time,
            value => Self::__Unknown(value),
}
    }
}

impl StaticType for LocaleType {
    fn static_type() -> Type {
        unsafe { from_glib(ffi::atspi_locale_type_get_type()) }
    }
}

impl glib::value::ValueType for LocaleType {
    type Type = Self;
}

unsafe impl<'a> FromValue<'a> for LocaleType {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
#[derive(Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "AtspiModifierType")]
pub enum ModifierType {
    #[doc(alias = "ATSPI_MODIFIER_SHIFT")]
    Shift,
    #[doc(alias = "ATSPI_MODIFIER_SHIFTLOCK")]
    Shiftlock,
    #[doc(alias = "ATSPI_MODIFIER_CONTROL")]
    Control,
    #[doc(alias = "ATSPI_MODIFIER_ALT")]
    Alt,
    #[doc(alias = "ATSPI_MODIFIER_META")]
    Meta,
    #[doc(alias = "ATSPI_MODIFIER_META2")]
    Meta2,
    #[doc(alias = "ATSPI_MODIFIER_META3")]
    Meta3,
    #[doc(alias = "ATSPI_MODIFIER_NUMLOCK")]
    Numlock,
#[doc(hidden)]
    __Unknown(i32),
}
...
impl fmt::Display for ModifierType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ModifierType::{}", match *self {
            Self::Shift => "Shift",
...
impl IntoGlib for ModifierType {
    type GlibType = ffi::AtspiModifierType;

    fn into_glib(self) -> ffi::AtspiModifierType {
        match self {
            Self::Shift => ffi::ATSPI_MODIFIER_SHIFT,
            Self::Shiftlock => ffi::ATSPI_MODIFIER_SHIFTLOCK,
            Self::Control => ffi::ATSPI_MODIFIER_CONTROL,
            Self::Alt => ffi::ATSPI_MODIFIER_ALT,
            Self::Meta => ffi::ATSPI_MODIFIER_META,
            Self::Meta2 => ffi::ATSPI_MODIFIER_META2,
            Self::Meta3 => ffi::ATSPI_MODIFIER_META3,
            Self::Numlock => ffi::ATSPI_MODIFIER_NUMLOCK,
            Self::__Unknown(value) => value,
}
    }
}
...
#[doc(hidden)]
impl FromGlib<ffi::AtspiModifierType> for ModifierType {
    unsafe fn from_glib(value: ffi::AtspiModifierType) -> Self {
        skip_assert_initialized!();
        match value {
            ffi::ATSPI_MODIFIER_SHIFT => Self::Shift,
            ffi::ATSPI_MODIFIER_SHIFTLOCK => Self::Shiftlock,
            ffi::ATSPI_MODIFIER_CONTROL => Self::Control,
            ffi::ATSPI_MODIFIER_ALT => Self::Alt,
            ffi::ATSPI_MODIFIER_META => Self::Meta,
            ffi::ATSPI_MODIFIER_META2 => Self::Meta2,
            ffi::ATSPI_MODIFIER_META3 => Self::Meta3,
            ffi::ATSPI_MODIFIER_NUMLOCK => Self::Numlock,
            value => Self::__Unknown(value),
}
    }
}
...
impl StaticType for ModifierType {
    fn static_type() -> Type {
        unsafe { from_glib(ffi::atspi_modifier_type_get_type()) }
    }
}
